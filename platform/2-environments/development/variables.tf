...
variable "folder_id" {
  description = "Development folder ID from 1-org outputs (e.g. folders/123456789). If not provided, will be pulled from 1-org remote state."
  type        = string
  default     = null
}
...
variable "dev_project_id" {
  description = "Unique project ID for development (e.g. aincrad-dev)."
  type        = string
...
variable "dev_ci_service_account" {
  description = "Dev CI service account email (from 1-org outputs) for granting editor role. If not provided, will be pulled from 1-org remote state."
  type        = string
  default     = null
}
